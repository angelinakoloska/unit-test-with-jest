...
test('map length', () => {
    ...
    // The mock function was called twice (once here and once in the previous test so we expect 2*2 = 4 calls)
...
test('override once', () => {
    ...
    // We want to access the value for the first of two parameters, so we use the .at(-2) to do that
